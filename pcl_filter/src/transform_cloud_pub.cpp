...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub = handler.subscribe("transformed_cloud_image_frame", 0.5, cloud_pub_callback);
    
    pub = handler.advertise<sensor_msgs::PointCloud2>("transformed_cloud", 0.5);
    ros::spin();
}
